...
#if defined(TARGET_FEDORA) || defined(TARGET_ARCH) || defined(TARGET_TERRA) || defined(TARGET_GENTOO) || defined(TARGET_ALTLINUX) || defined(TARGET_MANDRIVA) || defined(TARGET_MEEGO)
        int r;
        FILE *f;
